...
public class YelpDao {
	...
	public List<User> getUsersWithReviews(int minReviews){
		String sql = "SELECT u.user_id, u.votes_funny, u.votes_useful, u.votes_cool, u.name, u.average_stars,  review_count "
				+ "FROM Users u, Reviews r "
				+ "WHERE u.user_id = r.user_id "
				+ "GROUP BY u.user_id, u.votes_funny, u.votes_useful, u.votes_cool, u.name, u.average_stars,  review_count "
				+ "HAVING COUNT(*)>=? ";
